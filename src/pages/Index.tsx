...
import { Heart, Users, Droplets, TreeDeciduous, GraduationCap, Home, Shield, HandHeart } from "lucide-react";
...
const Index = () => {
  return (
    <Layout>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="section-heading">About Shijin Varghese</h2>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={index}
                className="card-tricolour bg-white/5 backdrop-blur-sm p-6 hover:bg-white/10 transition-colors duration-300"
              >
      ...
      {/* COVID-19 Pioneer Section */}
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          <div className="card-tricolour bg-background p-8 md:p-12 max-w-4xl mx-auto text-center">
            <Shield className="w-16 h-16 text-india-green mx-auto mb-6" />
            <h3 className="font-serif text-2xl md:text-3xl font-bold text-foreground mb-4">
              COVID-19 Response Pioneer
            </h3>
            <p className="text-muted-foreground leading-relaxed">
              When COVID-19 first affected Pathanamthitta District, Shijin Varghese became the <strong className="text-foreground">first volunteer in India</strong> to actively engage in COVID relief activities, playing a pioneering role in frontline support, public assistance, and emergency response during the initial outbreak.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <HandHeart className="w-16 h-16 text-saffron mx-auto mb-6" />
            <h3 className="font-serif text-2xl md:text-3xl font-bold text-foreground mb-4">
              Empowering Economic Independence
            </h3>
            <p className="text-muted-foreground leading-relaxed">
              Through self-employment initiatives, he has empowered individuals by distributing sewing machines, hens, and goats, fostering economic independence and sustainable livelihoods for countless families.
            </p>
          </div>
        </div>
      </section>
